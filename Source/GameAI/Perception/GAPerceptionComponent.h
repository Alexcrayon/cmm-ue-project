...
struct FVisionParameters
{
	...
	FVisionParameters() : VisionAngle(100.0f), VisionDistance(1500.0f) {}
...
class UGAPerceptionComponent : public UActorComponent
{
	...
	//Test every cell in the given grid against this percepeption comp, modify VMap if a cell was perceived(within vision cone and clear los)
	void TestVisibility(const AGAGridActor* Grid, FGAGridMap* VMap);
